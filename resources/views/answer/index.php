    ...
    <div>
        ...
        <table class="table table-striped" id="tableSort">
            ...
            <tr class="align-middle">
                <td style="width: 600px;"><?= $row['title'] ?></td>
                <td><?= $row['answers_count'] ?></td>
                <td>
                    <form method="post" action="/votes/<?=$row['vote_id']?>/answer/<?=$row['id']?>/edit">
                ...
                <td>
                    <form method="post" action="/votes/<?=$row['vote_id']?>/answer/<?=$row['id']?>/delete">
